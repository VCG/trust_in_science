...
let line_chart_complex_data;


// d3.csv("data/line_chart_complex.csv", (row,i) => {

d3.csv("https://raw.githubusercontent.com/VCG/trust_in_science/barbara_branch/line_chart/complex/data/line_chart_complex.csv", (row,i) => {
  ...
  //  row.Max_Week_Date = formatDate(row.Max_Week_Date);
    ...
    .then(loadData => {
        line_chart_complex_data = loadData
//      //console.log(new LineChart(data))
        new LineChartComplex(loadData)
