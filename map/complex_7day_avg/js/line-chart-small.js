    ...
    initVis() {
        ...
        let tip = d3.tip()
            ...
            .html(function(e, d) {
                ...
                return `<div style="text-align:center;font-weight:bold;margin-bottom: 10px;">${stateName}</div><div><b> Week: </b> ${dateFormatter(date)}<br /><b>Number of New Cases: ${Math.floor(value)}</b></div>`;
            });
